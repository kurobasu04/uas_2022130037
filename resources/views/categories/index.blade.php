                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <input type="text" id="search" class="form-control me-2" placeholder="Search by Name"
                                style="width: 40%;">
                            <!-- Add Category -->
                            <a href="{{ route('categories.create') }}" class="btn btn-md btn-success">ADD CATEGORY</a>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#search').on('keyup', function() {
                ...
                $('#category-list tr').filter(function() {
                    var categoryName = $(this).find('td:nth-child(2)').text().toLowerCase();
                    var isVisible = categoryName.indexOf(value) > -1;
